...
var Volume = function () {
    ...
    var widthStyle = {
        '--progress-bar-percentage': "".concat(Number.parseInt(volume[0]), "%")
    };
    return (react.createElement("div", { id: "volumeLevel", className: "progressBarRow row" },
        ...
        react.createElement("input", { type: "range", className: "progress", min: "0", max: "100", value: volume[0], onChange: function (e) { return setVolume([e.target.value, volume[0]]); }, style: widthStyle })));
};
...
function App() {
    ...
    react.useEffect(function () {
        ...
        log_pairs.forEach(function (_a) {
            var action = _a[0], func = _a[1];
            return Dispatcher.subscribe(action, func);
        });
        return function () {
            log_pairs.forEach(function (_a) {
                var action = _a[0], func = _a[1];
                return Dispatcher.unsubscribe(action, func);
            });
        };
    }, [accessToken]);
    return (react.createElement(react.Fragment, null,
...
module.exports = /** @class */ (function () {
    ...
    Discordify.prototype.load = function () { };
    Discordify.prototype.start = function () {
        var _a;
        debug_log('started!');
    ...
    Discordify.prototype.stop = function () {
        // @ts-expect-error
